          ...
          <Grid className="mt-5 pt-5 mb-1 pb-1" container spacing={2}>
            ...
            <Grid item lg={6} md={6} sm={12} xs={12}>
              <Carousel fade className='export-imgcaro'>
                <Carousel.Item>
                  <img className="d-block w-100" src={e1} alt="First slide" />
                  <Carousel.Caption>
                   
                  </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item>
                  <img className="d-block w-100" src={e2} alt="Second slide" />
                ...
                <Carousel.Item>
                  <img className="d-block w-100" src={e3} alt="Third slide" />
