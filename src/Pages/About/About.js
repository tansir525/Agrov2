...
const About = () => {
    return (
      <div className="rootabout">
          ...
          <Grid className="customabout" container spacing={0}>
            ...
            <Grid item lg={6} md={6} sm={12} xs={12}>
              <p>
                ...
                to ensure the utmost quality of the produce; and delivering the
                products to customers to satisfy their needs. As a comprehensive
                agro-business company, AgroVerse is marketing agro-products
                locally in Bangladesh and exporting them to different parts of
                the globe including Europe, North America, the Middle East, and
                South-East Asia.
              </p>
        ...
        <div className="try">
          <h5 className=" deviderContent  text-center container">
            AGROVERSE believes that the Global Food Security Challenge can be
            solved through innovation, and invests a lot in research to innovate
            sustainable agro-products to fulfill future exigency.{" "}
          </h5>
              ...
              <div>
                <div>
                  ...
                  <p>
                    ...
                    neque harum doloremque tempore consequatur sequi, nihil
                    laudantium sint molestiae recusandae.
                  </p>
                </div>
                <br /> <br /> <br />
                <div>
