...
import flip1 from '../../Assets/Environment/1.png'
import flip2 from '../../Assets/Environment/2.png'
import flip3 from '../../Assets/Environment/3.png'
import flip4 from '../../Assets/Environment/4.png'
import flip5 from '../../Assets/Environment/5.png'
import flip6 from '../../Assets/Environment/6.png'
...
<Grid container spacing={2}>
  ...
  <div class="flip-card-inner">
    <div class="flip-card-front">
        <img className='flipimg' src={flip1} alt="" />
  ...
  <div class="flip-card-inner">
    <div class="flip-card-front">
        <img className='flipimg' src={flip2} alt="" />
  ...
  <div class="flip-card-inner">
    <div class="flip-card-front">
        <img className='flipimg' src={flip3} alt="" />
  ...
  <div class="flip-card-inner">
    <div class="flip-card-front">
        <img className='flipimg' src={flip4} alt="" />
  ...
  <div class="flip-card-inner">
    <div class="flip-card-front">
        <img className='flipimg' src={flip5} alt="" />
  ...
  <div class="flip-card-inner">
    <div class="flip-card-front">
        <img className='flipimg' src={flip6} alt="" />
