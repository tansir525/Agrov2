...
<Grid className='p-5' container spacing={2}>
  ...
  <Grid className='footerlogo' item xs={6} md={4}>
  <img 
        src={logo}
        width="70%"
        height="60%"
 ...
 />
  ...
  <Grid item xs={6} md={4}>
  <p className='text-white parafooter'>We strive to contribute to achieving the Sustainable Development Goals through our business model.</p>
  </Grid>
  <Grid item xs={6} md={4}>
